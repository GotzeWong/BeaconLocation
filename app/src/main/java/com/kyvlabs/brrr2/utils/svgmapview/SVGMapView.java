package com.kyvlabs.brrr2.utils.svgmapview;
...
import com.kyvlabs.brrr2.utils.svgmapview.core.componet.MapMainView;
...
public class SVGMapView extends FrameLayout
{
    ...
    public SVGMapView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        WindowManager.LayoutParams _params = new WindowManager.LayoutParams(
